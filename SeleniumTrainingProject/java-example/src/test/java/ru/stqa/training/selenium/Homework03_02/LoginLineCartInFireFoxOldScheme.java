package ru.stqa.training.selenium.Homework03_02;
 ...
 */
public class LoginLineCartInFireFoxOldScheme {
    ...
    public void start() {
        ...
        FirefoxBinary bin = new FirefoxBinary(new File("C:\\Program Files (x86)\\FirefoxESR\\firefox.exe"));
