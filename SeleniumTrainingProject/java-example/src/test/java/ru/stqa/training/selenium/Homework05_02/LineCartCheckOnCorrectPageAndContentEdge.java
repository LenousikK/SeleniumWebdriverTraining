 ...
 */
public class LineCartCheckOnCorrectPageAndContentEdge {
        ...
        public void start() {
            ...
            public void testInEdge() {
                ...
                //Assert
                Assert.assertTrue(colorRegularPriceOnHomePage.equals("rgb(119, 119, 119)"));
                ...
                //Assert
                Assert.assertTrue(colorSalePriceOnHomePage.equals("rgb(204, 0, 0)"));
                Assert.assertTrue(fontWeightSalePriceOnHomePage.equals("700"));
                ...
                //Go to Product Page
                allCampaignsProducts.get(0).findElement(By.cssSelector(cssSelectorName + "> a.link")).sendKeys(Keys.ENTER);
                ...
                //Assert
                Assert.assertTrue(colorRegularPriceOnProductPage.equals("rgb(102, 102, 102)"));
                ...
                //Assert
                Assert.assertTrue(colorSalePriceOnProductPage.equals("rgb(204, 0, 0)"));
                Assert.assertTrue(fontWeightSalePriceOnProductPage.equals("700"));
